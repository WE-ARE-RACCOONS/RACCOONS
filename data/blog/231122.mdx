...
tags: ['Backend']
draft: false
summary: 'Filter와 Interceptor의 차이'
images: []
---
...
## ![](https://www.ywj9811.vercel.app/_next/image?url=%2Fstatic%2Fimages%2Ffi1.png&w=3840&q=75)

### (추가) 여기서 알 수 있는 것!

우리의 프로젝트를 보면 `RestControllerAdvice` 를 사용해서 전역에서 발생하는 예외에 대한 처리를 진행하고 있다.

하지만, 필터에서 발생한 예외는 여기서 처리를 하지 못한다…

**그 이유가 바로 위에서 나오는 DispatcherServlet 이전에 처리(스프링 범위 밖에서 처리)한다는 Filter의 특성 때문이다.**
...
![](https://www.ywj9811.vercel.app/_next/image?url=%2Fstatic%2Fimages%2Ffi2.png&w=3840&q=75)
...
public class CustomInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        *// 요청 처리 전에 실행할 코드를 작성합니다.// 예를 들어, 요청 인증, 로깅, 요청 시간 측정 등의 작업을 수행할 수 있습니다.*return true; *// true를 반환하면 요청을 계속 진행하고, false를 반환하면 요청을 중단합니다.*}
