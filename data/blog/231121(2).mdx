---
title: 'Dispatcher-Servlet(디스패처 서블릿)이란'
date: '2023-11-21'
tags: ['Backend']
draft: false
summary: 'Dispatcher-Servlet(디스패처 서블릿)이란'
images: []
---

🦡 작성자 : 원준

**Filter와 Interceptor에서 나오는 Dispatcher-Servlet에 대한 추가 설명입니다~**
...
![](https://www.ywj9811.vercel.app/_next/image?url=%2Fstatic%2Fimages%2Fdps%2Fdps1.png&w=828&q=75)
...
![](https://www.ywj9811.vercel.app/_next/image?url=%2Fstatic%2Fimages%2Fdps%2Fdps3.png&w=3840&q=75)

처리 과정은 위와 같은데,

1. 클라이언트의 요청을 디스패처 서블릿이 받음

   ![](https://www.ywj9811.vercel.app/_next/image?url=%2Fstatic%2Fimages%2Fdps%2Fdps4.png&w=3840&q=75)
